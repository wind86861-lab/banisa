...
// (credentials, mode, active) is sensitive clinic configuration → CLINIC_SETTINGS_EDIT.
...
router.post('/test-order', VIEW, testOrderHandler);
router.get('/test-orders', VIEW, testOrdersListHandler);
